# Code Background Remover 程式碼去背工具

Paste syntax-highlighted code copied from VS Code, and convert it for pasting into slides:

- Removes the dark editor background
